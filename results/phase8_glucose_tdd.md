...
*Caveat: overnight clean windows reduce but do not remove the carb confound; the magnitude of k from observational data is less reliable than the prior backtest. Per-window local-ISF is also hypo-biased in level (Phase 5/6), affecting the constant more than the exponents.*